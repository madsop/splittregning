...
class BratislavaMaaltidFactory {
    ...
    Maaltid getKaninMaaltid() {
        ...
        Maaltid<Euro> kaninMaaltid = new Maaltid<>("Kanin-måltid", bonaqua, slivovica, mangalica, diviakPomarancVillsvinFreddy,
    ...
    Maaltid getUrbanBistroMaaltid() {
        ...
        Maaltid<Euro> urbanBistroMaaltid = new Maaltid<>("Urban bistro", alt);
    ...
    Maaltid getILeiligheta() {
        ...
        Maaltid<Euro> iLeiligheta = new Maaltid<>("I leiligheta", f, e, l, ms, mo, s);
